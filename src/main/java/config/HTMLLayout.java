 ...
 *  modify for jbusiness @emetemunoy
 */
public class HTMLLayout extends Layout {
  ...
  */
  ...
  String getFooter() {
    ...
    sbuf.append("<br>" + Layout.LINE_SEP);
    sbuf.append("Java: " + System.getProperty("java.version") + " " + System.getProperty("java.vendor") + " " + System.getProperty("java.vm.name") + Layout.LINE_SEP);
    sbuf.append("<br>" + Layout.LINE_SEP);
    sbuf.append("System: " + System.getProperty("os.name") + " version " + System.getProperty("os.version") + " " + System.getProperty("os.arch") + Layout.LINE_SEP);
    sbuf.append("<br>" + Layout.LINE_SEP);
