...
public class NomenclatureListJFrame extends javax.swing.JFrame {
    ...
    private void getList() {
        ...
        for (Nomenclature nomenclature : dataList) {
            Object[] g = new Object[]{(nomenclature.isGroup().equals(Nomenclature.GROUP)) ? "Група" : "-", nomenclature.getId(), nomenclature, nomenclature.getArticleofgoods(), nomenclature.getArticleinside(), nomenclature.getQuantity(), nomenclature.getQuantitymin()};
            dataModel.addRow(g);
        }
    ...
    private void initComponents() {
        ...
        jTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Група", "id", "Найменування", "Заводський артикул", "Внутрішній артикул", "Кількість", "Мін. кількість"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.String.class, java.lang.Long.class, java.lang.Object.class, java.lang.String.class, java.lang.String.class, java.lang.Integer.class, java.lang.Integer.class
            };
