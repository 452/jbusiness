...
public class NomenclatureListJFrame extends javax.swing.JFrame {
    ...
    private void getList() {
        ...
        for (Nomenclature nomenclature : nomenclatureService.getDataList()) {
        	...
        	jPanelLayout.createParallelGroup(Alignment.LEADING)
        		.addGroup(jPanelLayout.createSequentialGroup()
        			...
        			.addGroup(jPanelLayout.createParallelGroup(Alignment.LEADING)
        				.addComponent(jButtonMove, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        				.addComponent(jButtonDelete, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        				.addComponent(jButtonEdit, GroupLayout.DEFAULT_SIZE, 38, Short.MAX_VALUE)
        				.addComponent(jButtonClose, GroupLayout.DEFAULT_SIZE, 38, Short.MAX_VALUE)
        				.addComponent(jButtonAdd, GroupLayout.DEFAULT_SIZE, 38, Short.MAX_VALUE)
        				.addComponent(jButtonAddGroup, GroupLayout.DEFAULT_SIZE, 38, Short.MAX_VALUE))
        			.addGap(14))
        );
