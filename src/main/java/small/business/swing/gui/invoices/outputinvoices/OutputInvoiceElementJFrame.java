...
public class OutputInvoiceElementJFrame extends javax.swing.JFrame {
	...
	private void initComponents() {
		...
		jPanelLabelsLayout.setVerticalGroup(jPanelLabelsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(jPanelLabelsLayout.createSequentialGroup().addGap(10, 10, 10).addGroup(jPanelLabelsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(jPanelLabelsLayout.createSequentialGroup().addGap(25, 25, 25).addComponent(jLabelStoreHouseTitle)).addComponent(jLabelCounterPartyTitle)).addGap(18, 18, 18).addComponent(jLabel3).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE).addComponent(jLabel4)));
		...
		}, new String[] { "id", "Номенклатура", "Кількість", "Вид ціни", "Ціна", "Сума" }) {
			/**
			 * 
			 */
			private static final long	serialVersionUID	= 1L;
			Class[]						types				= new Class[] { java.lang.Long.class, java.lang.Object.class, java.lang.Integer.class, java.lang.String.class, java.lang.String.class, java.lang.String.class };
