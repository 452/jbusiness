...
import small.business.swing.gui.invoices.cominginvoices.ComingInvoiceElementJFrame;
import small.business.swing.gui.invoices.cominginvoices.ComingInvoicesListJFrame;
 ...
 * @author ihor
 */
public class SuplyJFrame extends javax.swing.JFrame {
	...
	private void jButtonNewInvoiceActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButtonNewInvoiceActionPerformed
		...
		comingsInvoicesService.setCurrentElement(c);
	...
	private void jButtonInvoicesListActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButtonInvoicesListActionPerformed
		ComingInvoicesListJFrame comingInvoicesList = new ComingInvoicesListJFrame();
		comingInvoicesList.pack();
		ModalFrameUtil.showAsModal(comingInvoicesList, this);
		this.dispose();
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(SuplyJFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		}
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			public void run() {
				new SuplyJFrame().setVisible(true);
			}
		});
	}
