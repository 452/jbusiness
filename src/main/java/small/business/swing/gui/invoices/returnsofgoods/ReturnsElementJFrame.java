...
public class ReturnsElementJFrame extends javax.swing.JFrame {
	...
	private void initComponents() {
		...
		jPanelInfoLayout.setHorizontalGroup(jPanelInfoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(jLabelCounterParty, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE).addComponent(jLabelStoreHouse, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE).addGroup(jPanelInfoLayout.createSequentialGroup().addComponent(jComboBoxReturnsType, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE).addGap(0, 37, Short.MAX_VALUE)));
		jPanelInfoLayout.setVerticalGroup(jPanelInfoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(jPanelInfoLayout.createSequentialGroup().addContainerGap().addComponent(jLabelCounterParty).addGap(11, 11, 11).addComponent(jLabelStoreHouse).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(jComboBoxReturnsType, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE).addContainerGap()));
		...
		}, new String[] { "id", "Номенклатура", "Кількість", "Ціна", "Сума" }) {
			private static final long	serialVersionUID	= 1L;
			Class[]						types				= new Class[] { java.lang.Long.class, java.lang.Object.class, java.lang.Long.class, java.lang.Double.class, java.lang.Double.class };
		...
		jPanelLayout.setHorizontalGroup(jPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(jPanelLayout.createSequentialGroup().addGap(0, 0, 0).addGroup(jPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING).addComponent(jLabel1).addComponent(jLabel2)).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addGroup(jPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(jLabelAllGoodsQuantity).addComponent(jLabelAllGoodsPrice)).addContainerGap(160, Short.MAX_VALUE)));
	...
	private void jButtonRemoveGoodsActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButtonRemoveGoodsActionPerformed
		...
		if ((jTableGoods.getSelectedRow() >= 0) && (confirm == JOptionPane.YES_OPTION)) {
			...
			returnsOfGoodsService.getCurrentElement().getGoods().remove(selectedObject);
			getGoodsList();
		}
	...
	private void svalidate() {
		...
		jButtonRemoveGoods.setEnabled(returnsOfGoodsService.isCanRemove());
