...
public class ReturnsOfGoodsListJFrame extends javax.swing.JFrame {
	...
	private void getList() {
		...
		try {
			for (ReturnsOfGoodsInvoice returnsOfGoodsInvoice : returnsOfGoodsService.getDataList()) {
				Object[] g = new Object[] { returnsOfGoodsInvoice, (returnsOfGoodsInvoice.getTypeOfReturns().equals(0) ? "Повернення постачальнику" : "Повернення від клієнта"), DateFormat.getDateTimeInstance(DateFormat.FULL, DateFormat.SHORT).format(returnsOfGoodsInvoice.getReturningDate()), (returnsOfGoodsInvoice.getCounterParty() != null) ? returnsOfGoodsInvoice.getCounterParty().getTitle() : null, (returnsOfGoodsInvoice.getStoreHouse() != null) ? returnsOfGoodsInvoice.getStoreHouse() : null };
				dataModel.addRow(g);
			}
	...
	private void initComponents() {
		...
		}, new String[] { "id", "Вид повернення", "Дата", "Контрагент", "Склад" }) {
			private static final long	serialVersionUID	= 1L;
		...
		layout.setHorizontalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup().addContainerGap().addComponent(jButtonAdd).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(jButtonEdit).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(jButtonRemove).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 58, Short.MAX_VALUE).addComponent(jButtonClose).addContainerGap()).addComponent(jScrollPane, javax.swing.GroupLayout.Alignment.TRAILING));
		layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(layout.createSequentialGroup().addContainerGap().addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false).addComponent(jButtonAdd, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE).addComponent(jButtonClose, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)).addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false).addComponent(jButtonRemove, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE).addComponent(jButtonEdit, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE))).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(jScrollPane, javax.swing.GroupLayout.DEFAULT_SIZE, 166, Short.MAX_VALUE)));
	...
	private void jButtonRemoveActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButtonRemoveActionPerformed
		...
		if ((jTable.getSelectedRow() >= 0) && (confirm == JOptionPane.YES_OPTION)) {
			...
			try {
				returnsOfGoodsService.removeCurrentElement(selectedObject);
			}
			catch (Exception e) {
	...
	private void svalidate() {
		...
		jButtonRemove.setEnabled(returnsOfGoodsService.isCanRemove());
	}
