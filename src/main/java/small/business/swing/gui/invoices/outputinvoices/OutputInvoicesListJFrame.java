...
public class OutputInvoicesListJFrame extends javax.swing.JFrame {
	...
	private void initComponents() {
		...
		}, new String[] { "id", "Статус оплати", "Дата створення", "Контрагент/Постачальник", "Склад" }) {
			private static final long	serialVersionUID	= 1L;
			@SuppressWarnings("rawtypes")
			Class[]						types				= new Class[] { java.lang.Object.class, java.lang.String.class, java.lang.Object.class, java.lang.String.class, java.lang.String.class };
