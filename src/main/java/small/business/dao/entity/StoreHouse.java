...
@NamedQueries({ @NamedQuery(name = "StoreHouse.findAll", query = "SELECT s FROM StoreHouse s"), @NamedQuery(name = "StoreHouse.findById", query = "SELECT s FROM StoreHouse s WHERE s.id = :id"), @NamedQuery(name = "StoreHouse.findByTitle", query = "SELECT s FROM StoreHouse s WHERE s.title = :title") })
